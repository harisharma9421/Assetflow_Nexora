...
@IdClass(AuditCycleAuditor.Key.class)
public class AuditCycleAuditor {
    ...
    public static class Key implements java.io.Serializable {
        ...
        public boolean equals(Object value) {
            return value instanceof Key key && Objects.equals(auditCycleId, key.auditCycleId)
                    && Objects.equals(auditorUserId, key.auditorUserId);
        }

        @Override
        public int hashCode() {
            return Objects.hash(auditCycleId, auditorUserId);
        }
    }
}
