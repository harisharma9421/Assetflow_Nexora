...
public record AssetUpdateRequest(@NotBlank @Size(max = 150) String name, @NotNull Long categoryId,
        ...
        @Size(max = 150) String location, boolean bookable, Long owningDepartmentId, Map<Long, String> customFields) {
}
